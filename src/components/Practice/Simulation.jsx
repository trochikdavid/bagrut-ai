                        ...
                        <div className="question-card card intro-content">
                            ...
                            <div style={{
                                ...
                                <ul style={{ margin: 0, paddingRight: '20px', color: 'var(--text-secondary)', fontSize: '0.9rem', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                    ...
                                    <li><strong>תכנון:</strong> קחו 10–20 שניות לבנות מבנה ברור לתשובה: טענה ישירה ⬅ הסבר מעמיק ⬅ דוגמה תומכת ⬅ משפט סיום שמסכם את הרעיון.</li>
                                    <li><strong>אורך התשובה:</strong> כוונו למינימום דקה על הפרויקט, ולפחות 45 שניות בשאר..</li>
                                    <li><strong>זרימה וביטחון:</strong> טעיתם במילה? המשיכו הלאה זה טבעי! בודקים את יכולת התקשורת שלכם.</li>
                                </ul>
                            </div>
